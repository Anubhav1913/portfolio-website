document.addEventListener('DOMContentLoaded', function() {
    ...
    const projects = [
        {
            ...
            imageUrl: "https://placehold.co/600x400/1e40af/ffffff?text=Research",
        ...
        },
        {
            ...
            imageUrl: "https://placehold.co/600x400/1d4ed8/ffffff?text=Data",
        ...
        },
        {
            ...
            imageUrl: "https://placehold.co/600x400/2563eb/ffffff?text=AI+%26+NLP",
        ...
        },
        {
            ...
            imageUrl: "https://placehold.co/600x400/1e3a8a/ffffff?text=Research",
    ...
    const initPortfolioPage = () => {
        ...
        projects.forEach(project => {
            ...
            projectCard.className = 'project-card bg-white rounded-xl overflow-hidden shadow-md border border-slate-200 cursor-pointer';
            projectCard.dataset.category = project.category;
            projectCard.dataset.projectId = project.id;
            projectCard.innerHTML = `
                <div class="h-48 bg-slate-200 flex items-center justify-center">
                    <img src="${project.imageUrl}" alt="${project.title}" class="w-full h-full object-cover" onerror="this.onerror=null;this.parentElement.innerHTML='<span class=text-slate-500>${project.title}</span>';">
                </div>
                <div class="p-6">
                    <h3 class="font-bold text-xl mb-2 text-slate-900">${project.title}</h3>
                    <p class="text-slate-600 text-sm">${project.summary}</p>
                </div>
            `;
